...
public class FireDroidSettings extends PreferenceFragment {

    private static final String TAG = "FireDroidSettings";
    ...
    public void onCreate(Bundle icicle) {
		...
		addPreferencesFromResource(R.xml.firedroidsettings_prefs);
